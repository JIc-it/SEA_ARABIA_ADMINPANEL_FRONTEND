...
const ServiceEdit = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const findservice_price_service_destination_id =
        values.service_price_service.map((dat) => {
          if (dat?.location?.id) {
            return {
              id: dat.id,
              service: dat.service,
  ...
  useEffect(() => {
    ...
    getOneService(params.id)
      .then((data) => {
        ...
        formik.setFieldValue("embed", data?.map_embed);
                        ...
                        <div>
                          ...
                          >
                            <optgroup label="Selected Category">
                              ...
                              <option
                                selected
                                key={formik.values.category[0]?.id}
                                value={formik.values.category[0]?.id}
                              >
                        ...
                        <div className="mt-2">
                          ...
                          >
                            <optgroup label="Selected Sub-Category">
                              <option
                                selected
                                key={formik.values.sub_category[0]?.id}
                                value={formik.values.sub_category[0]?.id}
                              >
                          ...
                          {hovereffect === data.id && (
                            ...
                            >
                              <button
                                ...
                                onClick={() =>
                                  settingthumbnailTrue(data.id, data.service)
                                }
                              >
                                setThumbnail
                              </button>
