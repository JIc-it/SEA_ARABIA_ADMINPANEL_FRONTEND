...
import PerDateEditModal from './PerDateEditModal'

export default function PerDateTable({data,formik}) {
    ...
    return (
        <div className="">
            <div className="table-responsive">
                <table className="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <td>
                            <span className="text-secondary"> {dat?.end_date===null ? "-" :dat?.end_date}</span>
                        </td>
                        <td>
            ...
            {PerDateOpen && <PerDateEditModal handleClose={handleclosedate} handleOpen={handleopendate} open={PerDateOpen} data={passdata} formiks={formik}/>}
        </div>
    )
}
