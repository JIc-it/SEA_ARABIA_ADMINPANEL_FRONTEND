...
import PerDurationEditModal from './PerDurationEditModal'

export default function PerDurationTable({data,formik}) {
    const [PerDuration, setPerDurationOpen] = useState(false)
    ...
    return (
        <div className="">
            ...
            {PerDuration && <PerDurationEditModal handleClose={handlecloseduration} handleOpen={handleopenduration} open={PerDuration} data={passdata} formiks={formik}/>}
        </div>
    )
}
