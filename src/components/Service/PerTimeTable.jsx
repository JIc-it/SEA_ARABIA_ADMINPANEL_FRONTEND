...
import PerTimeEditModal from './PerTimeEditModal'

export default function PerTimeTable({data,formik}) {
...
const convertTo12HourFormat = (time24) => {
    ...
    return (
        <div className="">
            <div className="table-responsive">
                <table className="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <td>
                            <span className="text-secondary"> {convertTo12HourFormat(dat?.time)}</span>
                        </td>
                        <td>
                            <span className="text-secondary"> {dat?.end_time===null ? "-" :convertTo12HourFormat(dat?.end_time)}</span>
                        </td>
                        <td>
                        ...
                        >
                            ...
                            &nbsp;
                                <svg onClick={()=>handleremove(i)} style={{cursor:"pointer"}} xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
            ...
            {PerTimeOpen && <PerTimeEditModal handleClose={handleclosetime} handleOpen={handleopentime} open={PerTimeOpen} data={passdata} formiks={formik}/>}
        </div>
    )
}
