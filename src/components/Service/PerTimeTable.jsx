...
export default function PerTimeTable() {
    return (
        <div className="">
                ...
                <table className="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span className="text-secondary">07:00AM</span>
                            </td>
                            <td>
                                <span className="text-secondary">08:00PM </span>
                            </td>
                            <td>
                              <span className="text-secondary">80 KWD</span>
                            </td>
                            <td
                                style={{
                                    // display: "flex",
