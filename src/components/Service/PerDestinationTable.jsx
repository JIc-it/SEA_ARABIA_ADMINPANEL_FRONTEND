...
import PerDestinationEditModal from './PerDestinationEditModal'

export default function PerDestinationTable({data,formik}) {
    ...
    const handleremove = (id) => {
        formik((prev) => {
            const filterservice = prev.service_price_service.filter((dat) => dat.id !== id)
            return {
                ...prev,
                service_price_service: filterservice
            }
})
    }
    return (
        <div className="">
                ...
                <table className="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            &nbsp;
                                <svg onClick={()=>handleremove(dat.id)} style={{cursor:"pointer"}} xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
            ...
            {PerDestinationopen && <PerDestinationEditModal handleClose={handleclosedestination} handleOpen={handleopendestination} open={PerDestinationopen} data={passdata} formiks={formik}/>}
        </div>
    )
}
