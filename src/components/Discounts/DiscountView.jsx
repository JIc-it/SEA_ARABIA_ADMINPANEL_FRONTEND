...
export default function DiscountView() {
  ...
  useEffect(() => {
    ...
    Promise.all([getDiscountOfferView(params.id), getOneCompanyList(params.id)])
  ...
  function companywithservicelength(companyid) {
    const serviceCount =
      offerview?.servicelist?.map((dat) => {
        if (dat.company_id === companyid) {
          return dat.total_services;
        }
      }) || 0;
    return serviceCount;
  }

  const EditDiscountWithPermission = WithPermission(
    CommonButtonForPermission,
    permissionCategory.edit,
    menuIdConstant.offer,
    () => navigate("/discounts-offers/edit/" + offerview.id),
    "btn m-2",
    "Edit Discount ",
    { backgroundColor: "#2684FC", color: "white" },
    <svg
            ...
            <div className="d-flex">
              ...
              <div className="w-50">
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path
                          d="M6.5 11.916C6.5 8.85189 6.5 7.31982 7.4519 6.36792C8.40381 5.41602 9.93587 5.41602 13 5.41602H16.25C19.3141 5.41602 20.8462 5.41602 21.7981 6.36792C22.75 7.31982 22.75 8.85189 22.75 11.916V17.3327C22.75 20.3968 22.75 21.9289 21.7981 22.8808C20.8462 23.8327 19.3141 23.8327 16.25 23.8327H13C9.93587 23.8327 8.40381 23.8327 7.4519 22.8808C6.5 21.9289 6.5 20.3968 6.5 17.3327V11.916Z"
                          stroke="#68727D"
                          strokeWidth={2}
                        />
                        <path
                          d="M6.5 20.5827C4.70507 20.5827 3.25 19.1276 3.25 17.3327V10.8327C3.25 6.74718 3.25 4.70442 4.5192 3.43522C5.78841 2.16602 7.83116 2.16602 11.9167 2.16602H16.25C18.0449 2.16602 19.5 3.62109 19.5 5.41602"
                          stroke="#68727D"
                          strokeWidth={2}
                        />
                      </svg>
                ...
                <div>
                  ...
                  <p style={{ fontWeight: "700", fontSize: "14px" }}>
                    {offerview?.discount_value} %
                  </p>
                </div>
                <div>
                  <p style={{ color: "#68727D", fontSize: "16px" }}>Usage</p>
                  <p style={{ fontWeight: "700", fontSize: "14px" }}>
                    {offerview?.specify_no} / {offerview?.redemption_type}
                  </p>
                </div>
                <div>
                  <p style={{ color: "#68727D", fontSize: "16px" }}>
            ...
            {offerview?.companies?.map((datas) => (
              ...
              >
                ...
                <p className="typography-dicount-view">
                  ({companywithservice(datas.id)} of{" "}
                  {companywithservicelength(datas.id)} Services Selected )
                </p>
              </div>
            ))}
            ...
            <div className="d-flex">
              <div className="w-50">
                <div>
                  ...
                  <p style={{ fontWeight: "700", fontSize: "14px" }}>
                    {offerview?.purchase_requirement === true
                      ? "Minimum Requirement"
