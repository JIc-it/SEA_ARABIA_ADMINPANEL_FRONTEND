...
export default function PopupFilter({ open, handleClose, handleOpen,setListPageUrl,setOffersList}) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            if (!isLoading) {
                try {
                    const adminData = await getDiscountOfferList(null, formik.values);
                ...
                >
                    <Box sx={style}>
                        ...
                        <form onSubmit={formik.handleSubmit}>
                            {<div class={formik.values.status === true ? "frame-427319784 mt-2" : formik.values.status === false ? "frame-427319784 mt-2" : formik.values.startdate !== null ? "frame-427319784 mt-2" : formik.values.enddate !== null ? "frame-427319784 mt-2" : "mt-2"}>
                                ...
                                {<div class="components-selection-item">
                                    <div class="frame-427319782">
                                        ...
                                        <div class="completed-unsuccessful">{formik.values.status === true ? "Active" : "Inactive"}</div>
                                    </div>
                                ...
                                <div class="tab-content" id="v-pills-tabContent" style={{ position: "relative", left: 20 }}>
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                        ...
                                        <input
                                            ...
                                            style={{ width: 800 }}
                                        />
                                        <svg style={{ position: "absolute", top: "25%", right: "2%" }} width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip04346_25069)">
                                                <circle cx="9.58341" cy="9.58268" r="7.91667" stroke="#68727D" strokeWidth={2} />
                                                <path d="M15.4167 15.416L18.3334 18.3327" stroke="#68727D" strokeWidth={2} strokeLinecap="round" />
                                            </g>
                                            <defs>
                                                <clipPath id="clip0_4346_25069">
