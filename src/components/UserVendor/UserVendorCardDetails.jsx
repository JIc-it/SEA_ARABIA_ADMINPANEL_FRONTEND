            ...
            <div className={isMobileView ? "col-12 my-2" : "col-5 my-2"}>
                <div className="card personal_details" style={{height:"fit-content"}}>
                    <div className="card-body" >
                        ...
                        <div className="card_personal_details" style={{ backgroundColor: "#F8F8F8", borderRadius: "8px" }}>
                            <h5 className="personal_details_header" style={{ fontSize: "16px" }}>Personal Details</h5>
                            <div className="col-12">
                                <div className="vendor_info_new">
                                    <span className="heading_name">Email</span>
                                    <span>achille@gmail.com</span>
                                </div>
                            </div>
                            <div className="vendor_info_new">
                        ...
                        <div className="card_personal_details" style={{ backgroundColor: "#F8F8F8", borderRadius: "8px" }}>
                            <h5 className="personal_details_header" style={{ fontSize: "16px" }}>Company Details</h5>
                            <div className="col-12">
                                <div className="vendor_info_new">
                                ...
                                <div className="vendor_info_new">
                                    <span className="heading_name">Company Registration Number</span>
                                    <span>89546545421</span>
                                </div>
                                <div className="vendor_info_new">
                                    <span className="heading_name pb-2">Address</span>
                                    <span>Kuwait &nbsp;
                                        <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M10.9998 1.8335C6.94975 1.8335 3.6665 5.50253 3.6665 9.62516C3.6665 13.7155 6.00705 18.1615 9.65882 19.8684C10.5101 20.2663 11.4896 20.2663 12.3409 19.8684C15.9926 18.1615 18.3332 13.7155 18.3332 9.62516C18.3332 5.50253 15.0499 1.8335 10.9998 1.8335ZM10.9998 11.0002C12.0124 11.0002 12.8332 10.1794 12.8332 9.16683C12.8332 8.15431 12.0124 7.3335 10.9998 7.3335C9.98732 7.3335 9.1665 8.15431 9.1665 9.16683C9.1665 10.1794 9.98732 11.0002 10.9998 11.0002Z" fill="#323539" />
                                        </svg>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className="card_personal_details mt-3 " style={{ backgroundColor: "#F8F8F8", borderRadius: "8px" }}>
                            <div className="d-flex justify-content-between align-items-center">
                                <h5 className="personal_details_header" style={{ fontSize: "16px", transform: "translateY(-30%)" }}>Status</h5>
                                <div style={{ display: "flex" }}>
                                    <div className="me-2">{isToggled ? "Active" : "Inactive"}</div>
                    ...
                    <div className="card-body">
                        ...
                        {active === "Vendor Details" && <div>
                            ...
                            <div style={{ backgroundColor: "#F8F8F8", borderRadius: "5px" }} className="mt-4 w-100 px-2">
                                <p className="p-2" style={{ fontWeight: "700" }}>Personal Details</p>
                            ...
                            <div style={{ backgroundColor: "#F8F8F8", borderRadius: "5px" }} className="mt-4 w-100 px-2">
                                <p className="p-2" style={{ fontWeight: "700" }}>Company Details</p>
                                <div className="d-flex">
                                    <div className="col-4 px-2">
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <div className="d-flex justify-content-between">
                                                <p style={{ fontWeight: "700" }}>www.msccruises.com</p>
                                                <p>
                                                    <svg width="18" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.0003 1.83301C6.95024 1.83301 3.66699 5.50204 3.66699 9.62467C3.66699 13.715 6.00754 18.1611 9.6593 19.8679C10.5106 20.2658 11.4901 20.2658 12.3413 19.8679C15.9931 18.1611 18.3337 13.715 18.3337 9.62467C18.3337 5.50204 15.0504 1.83301 11.0003 1.83301ZM11.0003 10.9997C12.0128 10.9997 12.8337 10.1789 12.8337 9.16634C12.8337 8.15382 12.0128 7.33301 11.0003 7.33301C9.9878 7.33301 9.16699 8.15382 9.16699 9.16634C9.16699 10.1789 9.9878 10.9997 11.0003 10.9997Z" fill="#323539" />
                                                    </svg>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div>
                                            <p style={{ color: "#68727D" }}>Ownership</p>
                                                <p style={{ fontWeight: "700" }}>Third Party Ownership</p>
                                        </div>
                                 </div>
                                </div>
                            </div>
